...
Revision ID: 3941b320c446
Revises: None
Create Date: 2019-04-10 08:15:03.806236

"""

# revision identifiers, used by Alembic.
revision = '3941b320c446'
down_revision = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('cas', sa.DateTime(), nullable=False),
    sa.Column('nadpis', sa.VARCHAR(), nullable=False),
    sa.Column('CPU', sa.REAL(), nullable=False),
    sa.PrimaryKeyConstraint('id', name='pk_stats'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_stats_nadpis', 'stats', ['nadpis'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_stats_nadpis', table_name='stats')
    op.drop_table('stats')
